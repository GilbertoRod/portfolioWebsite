...
function Projects() {
    ...
    return (
      ...
      <div className='cards-wrapper' >
          ...
          description="This website was made for a home renovation contractor and was created using React, JavaScript, and CSS. I created this website from scratch and I used different media queries to make it fully responsive to different devices and screen sizes. The contractor wanted a website where they could display all of their work along with a page where potential clients can contact them. Using EmailJS, I created a contact form that potential clients can fill out and ask the business owner about a quote or any other questions that they may have about the business owners' work. Everytime that the form gets submitted, the business owner receives an email that contains all of the filled out information." 
          picture="smart.jpg" git='https://github.com/GilbertoRod/smarttechexpertsllc' site='https://dfwsmarttechexperts.com' stack={["react","js"]}/>
          ...
          picture="tillcount.PNG" git='https://github.com/GilbertoRod/TillCount' site={'https://till-count.vercel.app/'} stack={["js","html","css"]} />
